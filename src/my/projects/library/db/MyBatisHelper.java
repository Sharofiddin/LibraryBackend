package my.projects.library.db;
...
public class MyBatisHelper {
	...
	static {
		try {
			InputStream inputStream = Resources.getResourceAsStream("my/projects/library/db/MyBatisConfig.xml");
	...
	public <T> Cursor<T> selectCursor(String statement, Object parameter, RowBounds rowBounds) {
		...
		try {
			cursor = sqlSession.selectCursor(statement, parameter, rowBounds);
		} finally {
			sqlSession.close();
		}
		return cursor;
